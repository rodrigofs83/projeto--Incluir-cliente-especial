...
//reposta
// cliente especial
const cli4 = new ClienteEspecial('joao','123',c1,2,50);
console.log(`cliente especial =  ${cli4.nome}\n saldo conta = ${cli4.conta.saldo}\n saldo conta especial  = ${cli4.contaEspecial.saldo}\n saldo total = ${cli4.SaldoTotal()}`);
